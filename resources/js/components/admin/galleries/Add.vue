    ...
    <div class="box">
        ...
        <form id="submit_form" v-on:submit.prevent="submit">
            <div class="form-group">
                ...
                <div class="help">
                    <i class="fa fa-info-circle"></i> this photo will be gallery cover image
                </div>
            </div>
            <div class="form-group">
                <label>Title</label>
...
export default {
    ...
    methods : {
        ...
        handlePhotoChange(base64String){
            this.image_cover_name = base64String;
        },
        ...
        isValid(body){
            ...
            if(body.image_cover_name===null || body.image_cover_name===''){
                errors.push(true);
                //show toast
                this.$toast.open({
        ...
        submit(){
            ...
            //post body
            let body = {
                image_cover_name : this.image_cover_name,
                title : this.title,
            ...
            if(this.isValid(body)){
                //call API
                axios.post('/api/admin/galleries', body, userHelper.authenticationBearer())
                .then(res => {
                    if(res.status===200){
                        //check if success
