...
class NotificationController extends BaseController
{
    ...
    public function __construct(){
        //init model
        $this->model = new \App\Models\Admin_Notification; //your model name
    }
        ...
        try{
            ...
            $results = $this->model->
            			...
            			where(function($query){
			                $query->
			                where('message', 'LIKE', "%".$this->data['keyword']."%")->
    ...
    //total unread notification /total GET
    public function total(){
        $response = ['total'=>0, 'is_success' => false];
